...
const (
	OdometerReadingResult_ACCEPTED            OdometerReadingResult_Status = 0 // stored and it is now the asset's current reading
	OdometerReadingResult_IGNORED_OLDER       OdometerReadingResult_Status = 1 // stored in history only: read_at is older than the current one
	OdometerReadingResult_REJECTED_REGRESSION OdometerReadingResult_Status = 2 // not stored: miles below the current reading, no reason given
	OdometerReadingResult_NOT_FOUND           OdometerReadingResult_Status = 3 // unknown, soft-deleted, or wrong-type asset
	OdometerReadingResult_ERROR               OdometerReadingResult_Status = 4 // anything else; message carries the detail
)

// Enum value maps for OdometerReadingResult_Status.
var (
	OdometerReadingResult_Status_name = map[int32]string{
		0: "ACCEPTED",
		1: "IGNORED_OLDER",
		2: "REJECTED_REGRESSION",
		3: "NOT_FOUND",
		4: "ERROR",
	}
	OdometerReadingResult_Status_value = map[string]int32{
		"ACCEPTED":            0,
		"IGNORED_OLDER":       1,
...
func (x OdometerReadingResult_Status) Enum() *OdometerReadingResult_Status {
	p := new(OdometerReadingResult_Status)
	*p = x
	return p
}

func (x OdometerReadingResult_Status) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
type OdometerReadingInput struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	AssetId       string                 `protobuf:"bytes,1,opt,name=asset_id,json=assetId,proto3" json:"asset_id,omitempty"`       // UUID of the truck or trailer
	Type          VehicleType            `protobuf:"varint,2,opt,name=type,proto3,enum=trackers.VehicleType" json:"type,omitempty"` // VEHICLE_TYPE_TRUCK | VEHICLE_TYPE_TRAILER
	Miles         float64                `protobuf:"fixed64,3,opt,name=miles,proto3" json:"miles,omitempty"`
	ReadAt        *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=read_at,json=readAt,proto3" json:"read_at,omitempty"` // when the meter was read; empty means now
	Source        string                 `protobuf:"bytes,5,opt,name=source,proto3" json:"source,omitempty"`               // SAMSARA | TRIP_ESTIMATE
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *OdometerReadingInput) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *OdometerReadingInput) GetType() VehicleType {
	if x != nil {
		return x.Type
	}
	return VehicleType_VEHICLE_TYPE_UNSPECIFIED
...
func (x *OdometerReadingInput) GetMiles() float64 {
	if x != nil {
		return x.Miles
	}
	return 0
...
func (x *OdometerReadingInput) GetReadAt() *timestamppb.Timestamp {
	if x != nil {
		return x.ReadAt
	}
	return nil
...
func (x *OdometerReadingInput) GetSource() string {
	if x != nil {
		return x.Source
	}
	return ""
...
type OdometerReadingResult struct {
	state         protoimpl.MessageState       `protogen:"open.v1"`
	AssetId       string                       `protobuf:"bytes,1,opt,name=asset_id,json=assetId,proto3" json:"asset_id,omitempty"`
	Status        OdometerReadingResult_Status `protobuf:"varint,2,opt,name=status,proto3,enum=trackers.OdometerReadingResult_Status" json:"status,omitempty"`
	Message       string                       `protobuf:"bytes,3,opt,name=message,proto3" json:"message,omitempty"`
	StoredMiles   float64                      `protobuf:"fixed64,4,opt,name=stored_miles,json=storedMiles,proto3" json:"stored_miles,omitempty"` // the asset's current reading after this call
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *OdometerReadingResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *OdometerReadingResult) GetStatus() OdometerReadingResult_Status {
	if x != nil {
		return x.Status
	}
	return OdometerReadingResult_ACCEPTED
}

func (x *OdometerReadingResult) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *OdometerReadingResult) GetStoredMiles() float64 {
	if x != nil {
		return x.StoredMiles
	}
	return 0
}

type RecordOdometerReadingsRequest struct {
	state         protoimpl.MessageState  `protogen:"open.v1"`
	Readings      []*OdometerReadingInput `protobuf:"bytes,1,rep,name=readings,proto3" json:"readings,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RecordOdometerReadingsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type RecordOdometerReadingsResponse struct {
	state         protoimpl.MessageState   `protogen:"open.v1"`
	Results       []*OdometerReadingResult `protobuf:"bytes,1,rep,name=results,proto3" json:"results,omitempty"` // one per request reading, in order
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RecordOdometerReadingsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
const file_trackers_trackers_proto_rawDesc = "" +
	...
	"\x03lng\x18\x04 \x01(\x01R\x03lng\"\xbf\x01\n" +
	"\x14OdometerReadingInput\x12\x19\n" +
	"\basset_id\x18\x01 \x01(\tR\aassetId\x12)\n" +
	"\x04type\x18\x02 \x01(\x0e2\x15.trackers.VehicleTypeR\x04type\x12\x14\n" +
	"\x05miles\x18\x03 \x01(\x01R\x05miles\x123\n" +
	"\aread_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\x06readAt\x12\x16\n" +
	"\x06source\x18\x05 \x01(\tR\x06source\"\x8d\x02\n" +
	"\x15OdometerReadingResult\x12\x19\n" +
	"\basset_id\x18\x01 \x01(\tR\aassetId\x12>\n" +
	"\x06status\x18\x02 \x01(\x0e2&.trackers.OdometerReadingResult.StatusR\x06status\x12\x18\n" +
	"\amessage\x18\x03 \x01(\tR\amessage\x12!\n" +
	"\fstored_miles\x18\x04 \x01(\x01R\vstoredMiles\"\\\n" +
	"\x06Status\x12\f\n" +
	"\bACCEPTED\x10\x00\x12\x11\n" +
	"\rIGNORED_OLDER\x10\x01\x12\x17\n" +
	"\x13REJECTED_REGRESSION\x10\x02\x12\r\n" +
