...
const (
	...
	TrackersService_UpdateStopETA_FullMethodName      = "/trackers.TrackersService/UpdateStopETA"
)
...
type TrackersServiceClient interface {
	...
	// GetActiveTripStops returns pending trip stops for a truck
	...
	// UpdateStopETA updates the planned arrival time for a trip stop
	UpdateStopETA(ctx context.Context, in *UpdateStopETARequest, opts ...grpc.CallOption) (*UpdateStopETAResponse, error)
}
...
func (c *trackersServiceClient) UpdateStopETA(ctx context.Context, in *UpdateStopETARequest, opts ...grpc.CallOption) (*UpdateStopETAResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateStopETAResponse)
	err := c.cc.Invoke(ctx, TrackersService_UpdateStopETA_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TrackersServiceServer interface {
	...
	// UpdateStopETA updates the planned arrival time for a trip stop
	UpdateStopETA(context.Context, *UpdateStopETARequest) (*UpdateStopETAResponse, error)
...
func (UnimplementedTrackersServiceServer) UpdateStopETA(context.Context, *UpdateStopETARequest) (*UpdateStopETAResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateStopETA not implemented")
}
...
func _TrackersService_UpdateStopETA_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateStopETARequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TrackersServiceServer).UpdateStopETA(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TrackersService_UpdateStopETA_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TrackersServiceServer).UpdateStopETA(ctx, req.(*UpdateStopETARequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TrackersService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateStopETA",
			Handler:    _TrackersService_UpdateStopETA_Handler,
		},
	},
