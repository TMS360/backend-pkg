...
func (c *brokerServiceClient) GetBrokers(ctx context.Context, in *GetBrokersRequest, opts ...grpc.CallOption) (*GetBrokersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetBrokersResponse)
	err := c.cc.Invoke(ctx, BrokerService_GetBrokers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BrokerService_GetBrokers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBrokersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BrokerServiceServer).GetBrokers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BrokerService_GetBrokers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BrokerServiceServer).GetBrokers(ctx, req.(*GetBrokersRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _BrokerService_GetOrCreateByMC_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetOrCreateByMCRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BrokerServiceServer).GetOrCreateByMC(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BrokerService_GetOrCreateByMC_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BrokerServiceServer).GetOrCreateByMC(ctx, req.(*GetOrCreateByMCRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BrokerService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "brokers.BrokerService",
	HandlerType: (*BrokerServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetBrokers",
			Handler:    _BrokerService_GetBrokers_Handler,
		},
		{
	...
	Metadata: "brokers/brokers.proto",
}
