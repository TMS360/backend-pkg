...
const file_files_files_proto_rawDesc = "" +
	...
	"\fcontent_type\x18\x03 \x01(\tR\vcontentType2\x99\x02\n" +
	"\fFilesService\x128\n" +
	...
	"\x10ListCompanyFiles\x12\x1e.files.ListCompanyFilesRequest\x1a\x1f.files.ListCompanyFilesResponseB+Z)github.com/TMS360/backend-pkg/proto/filesb\x06proto3"
...
var file_files_files_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_files_files_proto_goTypes = []any{
	...
	nil,                              // 9: files.GetFilesResponse.FilesEntry
}
var file_files_files_proto_depIdxs = []int32{
	2, // 0: files.GetFileResponse.file:type_name -> files.File
	9, // 1: files.GetFilesResponse.files:type_name -> files.GetFilesResponse.FilesEntry
	2, // 2: files.ListCompanyFilesResponse.files:type_name -> files.File
	2, // 3: files.GetFilesResponse.FilesEntry.value:type_name -> files.File
	0, // 4: files.FilesService.GetFile:input_type -> files.GetFileRequest
	1, // 5: files.FilesService.GetFiles:input_type -> files.GetFilesRequest
	7, // 6: files.FilesService.Download:input_type -> files.DownloadRequest
	5, // 7: files.FilesService.ListCompanyFiles:input_type -> files.ListCompanyFilesRequest
	3, // 8: files.FilesService.GetFile:output_type -> files.GetFileResponse
	4, // 9: files.FilesService.GetFiles:output_type -> files.GetFilesResponse
	8, // 10: files.FilesService.Download:output_type -> files.DownloadResponse
	6, // 11: files.FilesService.ListCompanyFiles:output_type -> files.ListCompanyFilesResponse
