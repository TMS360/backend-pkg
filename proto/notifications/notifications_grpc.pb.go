...
const (
	NotificationsService_RequestDriverLocation_FullMethodName = "/notifications.NotificationsService/RequestDriverLocation"
)
...
type NotificationsServiceClient interface {
	RequestDriverLocation(ctx context.Context, in *RequestDriverLocationReq, opts ...grpc.CallOption) (*RequestDriverLocationRes, error)
}
...
func (c *notificationsServiceClient) RequestDriverLocation(ctx context.Context, in *RequestDriverLocationReq, opts ...grpc.CallOption) (*RequestDriverLocationRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RequestDriverLocationRes)
	err := c.cc.Invoke(ctx, NotificationsService_RequestDriverLocation_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NotificationsServiceServer interface {
	RequestDriverLocation(context.Context, *RequestDriverLocationReq) (*RequestDriverLocationRes, error)
...
func (UnimplementedNotificationsServiceServer) RequestDriverLocation(context.Context, *RequestDriverLocationReq) (*RequestDriverLocationRes, error) {
	return nil, status.Error(codes.Unimplemented, "method RequestDriverLocation not implemented")
}
...
func _NotificationsService_RequestDriverLocation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestDriverLocationReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NotificationsServiceServer).RequestDriverLocation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NotificationsService_RequestDriverLocation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotificationsServiceServer).RequestDriverLocation(ctx, req.(*RequestDriverLocationReq))
	}
...
var NotificationsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "RequestDriverLocation",
			Handler:    _NotificationsService_RequestDriverLocation_Handler,
		},
	},
