...
type CheckDispatchComplianceRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Driver account UUID. Empty when the dispatch carries no driver.
	DriverId string `protobuf:"bytes,1,opt,name=driver_id,json=driverId,proto3" json:"driver_id,omitempty"`
	// Truck UUID. Empty when the dispatch carries no truck.
	TruckId string `protobuf:"bytes,2,opt,name=truck_id,json=truckId,proto3" json:"truck_id,omitempty"`
	// Trailer UUID. Optional; evaluated only when present.
	TrailerId     string `protobuf:"bytes,3,opt,name=trailer_id,json=trailerId,proto3" json:"trailer_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *CheckDispatchComplianceRequest) Reset() {
	*x = CheckDispatchComplianceRequest{}
	mi := &file_files_files_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CheckDispatchComplianceRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CheckDispatchComplianceRequest) ProtoMessage() {}

func (x *CheckDispatchComplianceRequest) ProtoReflect() protoreflect.Message {
	mi := &file_files_files_proto_msgTypes[14]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CheckDispatchComplianceRequest.ProtoReflect.Descriptor instead.
func (*CheckDispatchComplianceRequest) Descriptor() ([]byte, []int) {
	return file_files_files_proto_rawDescGZIP(), []int{14}
}

func (x *CheckDispatchComplianceRequest) GetDriverId() string {
	if x != nil {
		return x.DriverId
	}
	return ""
...
func (x *CheckDispatchComplianceRequest) GetTruckId() string {
	if x != nil {
		return x.TruckId
	}
	return ""
...
func (x *CheckDispatchComplianceRequest) GetTrailerId() string {
	if x != nil {
		return x.TrailerId
	}
	return ""
...
// BlockingDocument is one required + enforced document that is missing or
// lapsed on one of the requested entities.
type BlockingDocument struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Asset class the document is required for: DRIVER, TRUCK or TRAILER.
	EntityType string `protobuf:"bytes,1,opt,name=entity_type,json=entityType,proto3" json:"entity_type,omitempty"`
	// UUID of that asset (echoed from the request).
	...
	// Human-readable document type name, for the dispatcher-facing message.
	DocumentTypeName string `protobuf:"bytes,4,opt,name=document_type_name,json=documentTypeName,proto3" json:"document_type_name,omitempty"`
	// MISSING (nothing acceptable on file) or EXPIRED (past expires_at + the
	// type's grace days). Nothing else can block.
	Status string `protobuf:"bytes,5,opt,name=status,proto3" json:"status,omitempty"`
	// Expiry date of the lapsed document as YYYY-MM-DD. Empty for MISSING and
	// for a document with no expiry date on file.
	ExpiresAt     string `protobuf:"bytes,6,opt,name=expires_at,json=expiresAt,proto3" json:"expires_at,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *BlockingDocument) Reset() {
	*x = BlockingDocument{}
...
func (x *BlockingDocument) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BlockingDocument) ProtoMessage() {}

func (x *BlockingDocument) ProtoReflect() protoreflect.Message {
	mi := &file_files_files_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BlockingDocument.ProtoReflect.Descriptor instead.
func (*BlockingDocument) Descriptor() ([]byte, []int) {
	return file_files_files_proto_rawDescGZIP(), []int{15}
}

func (x *BlockingDocument) GetEntityType() string {
	if x != nil {
		return x.EntityType
	}
	return ""
...
func (x *BlockingDocument) GetEntityId() string {
	if x != nil {
		return x.EntityId
	}
	return ""
...
func (x *BlockingDocument) GetDocumentTypeId() string {
	if x != nil {
		return x.DocumentTypeId
	}
	return ""
...
func (x *BlockingDocument) GetDocumentTypeName() string {
	if x != nil {
...
func (x *BlockingDocument) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *BlockingDocument) GetExpiresAt() string {
	if x != nil {
		return x.ExpiresAt
	}
	return ""
...
type CheckDispatchComplianceResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// True when at least one blocking document was found.
	Blocked bool `protobuf:"varint,1,opt,name=blocked,proto3" json:"blocked,omitempty"`
	// Every blocking document, grouped per entity in a stable order.
	Blocking      []*BlockingDocument `protobuf:"bytes,2,rep,name=blocking,proto3" json:"blocking,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *CheckDispatchComplianceResponse) Reset() {
	*x = CheckDispatchComplianceResponse{}
	mi := &file_files_files_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CheckDispatchComplianceResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CheckDispatchComplianceResponse) ProtoMessage() {}

func (x *CheckDispatchComplianceResponse) ProtoReflect() protoreflect.Message {
	mi := &file_files_files_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CheckDispatchComplianceResponse.ProtoReflect.Descriptor instead.
func (*CheckDispatchComplianceResponse) Descriptor() ([]byte, []int) {
	return file_files_files_proto_rawDescGZIP(), []int{16}
}

func (x *CheckDispatchComplianceResponse) GetBlocked() bool {
	if x != nil {
		return x.Blocked
	}
	return false
...
func (x *CheckDispatchComplianceResponse) GetBlocking() []*BlockingDocument {
	if x != nil {
		return x.Blocking
	}
	return nil
...
const file_files_files_proto_rawDesc = "" +
	...
	"\x1eCheckDispatchComplianceRequest\x12\x1b\n" +
	"\tdriver_id\x18\x01 \x01(\tR\bdriverId\x12\x19\n" +
	"\btruck_id\x18\x02 \x01(\tR\atruckId\x12\x1d\n" +
	"\n" +
	"trailer_id\x18\x03 \x01(\tR\ttrailerId\"\xdf\x01\n" +
	"\x10BlockingDocument\x12\x1f\n" +
	"\ventity_type\x18\x01 \x01(\tR\n" +
	"entityType\x12\x1b\n" +
	"\tentity_id\x18\x02 \x01(\tR\bentityId\x12(\n" +
	"\x10document_type_id\x18\x03 \x01(\tR\x0edocumentTypeId\x12,\n" +
	"\x12document_type_name\x18\x04 \x01(\tR\x10documentTypeName\x12\x16\n" +
